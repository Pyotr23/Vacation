        ...
        public static void EnsurePopulated(IApplicationBuilder app)
        {
            ...
            if (!context.Vacations.Any())
            {
                ...
                context.Vacations.AddRange(
                    ...
                    new Vacation { Start = new DateTime(2019, 3, 11), Duration = 7, Employee = context.Employees.ElementAt(0) },
                    new Vacation { Start = new DateTime(2019, 5, 1), Duration = 28, Employee = context.Employees.ElementAt(1) },
                    new Vacation { Start = new DateTime(2019, 4, 30), Duration = 7, Employee = context.Employees.ElementAt(2) },
